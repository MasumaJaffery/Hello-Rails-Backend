...
**Hello Rails Backend** is an exercise with 2 repos, but features a random generated greeting message.
...
```sh
  cd your-folder
  git@github.com:MasumaJaffery/Hello-Rails-Frontend.git
```
...
Feel free to check the [issues page](https://github.com/MasumaJaffery/hello-rails-backend/issues).
